...
public class BurguerConfigurator {
    ...
    public BurguerConfigurator() {
        ...
        assert INGREDIENTS.length != COSTS.length : "all arrays should have the same length";
    }

    /**
     * Calculates the cost for the burguer     * @return A real with the total cost.
     */
    ...
    /**
     * Returns selected ingredients as a string.     *  @param newDelimiter The delimiter to use to end each line.     *  @returns A single string with the whole contents.
     */
     ...
     */
    public static String[] INGREDIENTS = new String[]{"Lechuga", "Tomate", "Queso", "York", "Cebolla"};
    /**
     ...
     */
    public static double[] FIXED_COSTS = new double[]{1, 2};
